...
The chatbot will be made available and accessible by registered users throughout the semester (except for the period during maintenance or otherwise informed by the chatbot administrator). Only student enrolled in SC1015/CE1115/CZ1115 are allowed to register as a user using the NTU email address. Upon registered, your NTU email address and your name will be recorded in the database. Your conversation and interaction with the chatbot, i.e. chatlog, will be recorded in the database as well.
